...
class AVSS4_SemanticDatasetMapper:
    ...
    def __call__(self, dataset_dict):
        ...
        if "category_label" in dataset_dict:
            category_label = dataset_dict.pop("category_label")
        else:
            raise ValueError("Cannot find 'category_label' for semantic segmentation dataset {}.".format(dataset_dict["file_names"]))
        dataset_dict["category_label"] = category_label
